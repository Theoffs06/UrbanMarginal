...
public class Duree implements Serializable
{
  ...
  public Duree(int seconde, int microseconde){
    ...
    if(seconde < 0) throw new IllegalArgumentException("Le nombre de secondes ne peut pas �tre n�gative");
    if(seconde > 59) throw new IllegalArgumentException("Le nombre de secondes ne peut pas �tre plus de 59, sinon on a des minutes");
  ...
  public Duree(int minute, int seconde, int microseconde){
    ...
    if(minute > 59) throw new IllegalArgumentException("Le nombre minutes ne peut pas �tre plus de 59, sinon on a des heures");
